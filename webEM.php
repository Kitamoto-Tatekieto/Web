...
<nav class="navbar navbar-expand-lg">
  <div class="container-fluid">
    <a class="navbar-brand" href="webEM.php">Elenaspa</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="recepcionista/Datos/worker.php">Actualizar Datos</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="recepcionista/Cliente/mainclientes.php">Cliente</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="recepcionista/Servicio/Servicios.php">Servicios</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="recepcionista/Reserva/nueva_venta.php">Gestionar reservas</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="recepcionista/Reserva/ConsultarR.php">Reservas</a>
        </li>
        <li class="nav-item">
...
<div class="container mt-5">
    <div class="row"> <!-- Aquí se agrega la fila -->
        <div class="col-md-4 mb-4">
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <a href="recepcionista/Cliente/mainclientes.php" class="btn btn-primary">Gestionar Clientes</a>
                </div>
            </div>
        </div>
        <div class="col-md-4 mb-4">
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <a href="recepcionista/Servicio/Servicios.php" class="btn btn-primary">Gestionar Servicios</a>
                </div>
            </div>
        </div>
        <div class="col-md-4 mb-4">
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <a href="recepcionista/Reserva/nueva_venta.php" class="btn btn-primary">Gestionar Reservas</a>
                </div>
            </div>
        </div>
